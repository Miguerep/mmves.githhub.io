...
const socials = [
  {
    name: 'GitHub',
    href: 'https://github.com/Miguerep',
    icon: (
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/miguel-milla-b896362b8/',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    name: 'Email',
    href: 'mailto:miguerepvfr@gmail.com',
    icon: (
  ...
  return (
    <section className="section section-alt" id="contact">
      <div className="container contact-container" ref={ref}>
        ...
        <p
          className={`contact-sub fade-in${inView ? ' visible' : ''}`}
          style={{ transitionDelay: '0.1s' }}
        >
          I'm always open to new opportunities and interesting projects.
          <br />Feel free to reach out — I respond within 24 hours.
        </p>
        <div
